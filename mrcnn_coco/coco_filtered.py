"""
This is an adaption of the coco.py class by Matterport, that filters out non-VUFO classes.
"""
...
def evaluate_coco(model, dataset, coco, eval_type="bbox", limit=0, image_ids=None):
    ...
    # Filter out non-VUFO classes that we are not interested in
    class_filter = []
    ...
    for i, image_id in enumerate(image_ids):
        ...
        r = misc.filter_result_for_classes(r, class_filter)
