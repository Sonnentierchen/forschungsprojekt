...
class DetectionTargetLayer(KE.Layer):
    """Subsamples proposals and generates target box refinment and class_ids for each.
...
def load_image_gt(dataset, config, image_id, augment=False):
    ...
    class_ids, bbox = dataset.load_bboxes(image_id)
    shape = image.shape
    ...
    # TODO: Implement an actual augmentation
...
def build_rpn_targets(image_shape, anchors, gt_class_ids, gt_boxes, config):
    ...
    for i, a in zip(ids, anchors[ids]):
        ...
        if a_h == 0 or a_w == 0 or gt_h == 0 or gt_w == 0:
            print("Anchor {} {} {} {}".format(a_h, a_w, a_center_y, a_center_x))
