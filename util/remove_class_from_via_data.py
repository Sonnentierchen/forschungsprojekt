...
def remove_class_from_via_data(annotations_path, class_to_remove, output_path):
    ...
    removed_class_annotations_file_name = annotations_file_name + "_removed_class" + extension

    with open(annotations_file_name, "r") as json_file, open(removed_class_annotations_file_name, "w") as removed_class_json_file:
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Removes a specified category class from a given VIA format file because sometimes those classes are added by " +
